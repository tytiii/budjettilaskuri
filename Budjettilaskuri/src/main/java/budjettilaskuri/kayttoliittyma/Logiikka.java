 ...
 * @author mylly
 */
public class Logiikka implements ActionListener {
    ...
    public Logiikka(Ohjelma o) {
        ...
        this.kayttajat = new KayttajaVarasto(f);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(komento.equals("UUSI")) {
            ...
            if(uusikayttaja.length() < 2) {
                Virhe v = new Virhe("Liian lyhyt käyttäjätunnus!");
            }
            else if(this.kayttajat.LisaaKayttaja(uusikayttaja, f)) {
